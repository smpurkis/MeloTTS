...
onnx_model = onnx.load("/Users/user/demo_1/tts-pg/model_dec.onnx")

x_in: np.ndarray = np.load("/Users/user/demo_1/tts-pg/MeloTTS/to_onnx_test/x_input.npy")
g_in: np.ndarray = np.load("/Users/user/demo_1/tts-pg/MeloTTS/to_onnx_test/g_input.npy")
gt_o_output: np.ndarray = np.load(
    "/Users/user/demo_1/tts-pg/MeloTTS/to_onnx_test/o_output.npy"
)
